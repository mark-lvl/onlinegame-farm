...
<div>
    ...
    <div style="float:right; text-align:right;">
		...
		<param name="swliveconnect" value="true" />
                <param FlashVars="url_file=<?= css_url() ?>system/application/assets/flashes/&url_base=<?= base_url() ?>" />
                <param url_file="<?= css_url() ?>system/application/assets/flashes/" />
                <param url_base="<?= base_url() ?>" />
		<param name="movie" value="<?= css_url() ?>system/application/assets/flashes/yummyAvatar{89-3-22}M.swf?<?= date('H:i:s') ?>" />
                <param name="quality" value="high" />
                <param name="bgcolor" value="#ffffff" />
                <param name="wmode" value="transparent" />
                <embed swliveconnect="true" url_file="<?= css_url() ?>system/application/assets/flashes/" url_base="<?= base_url() ?>" FlashVars="url_file=<?= css_url() ?>system/application/assets/flashes/&url_base=<?= base_url() ?>" src="<?= css_url() ?>system/application/assets/flashes/yummyAvatar{89-3-22}M.swf?<?= date('H:i:s') ?>" quality="high" bgcolor="#ffffff" width="460" height="390" name="design_car" wmode="transparent" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
		</object>
        <?php else: ?>
                <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="460" height="390" id="design_car" align="middle">
		<param name="allowScriptAccess" value="sameDomain" />
		...
		<param name="movie" value="<?= base_url() ?>system/application/assets/flashes/girl/yummyAvatar{89-3-18}F.swf" />
                <param name="quality" value="high" /><param name="bgcolor" value="#ffffff" />
                <param name="wmode" value="transparent" />
                <embed swliveconnect="true" FlashVars="url_file=<?= css_url() ?>system/application/assets/flashes/girl/&url_base=<?= base_url() ?>" src="<?= css_url() ?>system/application/assets/flashes/girl/yummyAvatar{89-3-22}F.swf?<?= date('H:i:s') ?>" quality="high" bgcolor="#ffffff" width="460" height="390" name="design_car" wmode="transparent" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
		</object>
